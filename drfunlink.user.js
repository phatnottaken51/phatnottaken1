    ...
    async function bypassFunlink() {
        ...
        try {
            ...
            const keywordResponse = await new Promise((resolve, reject) => {
                GM_xmlhttpRequest({
                    method: 'GET',
                    url: `https://public-dr.funlink.io/api/code/renew-key?ignoreId=${rad}&id=${id}`,
                    headers: {
                        'accept': '*/*',
            ...
            await new Promise((resolve, reject) => {
                GM_xmlhttpRequest({
                    method: 'OPTIONS',
                    url: 'https://public-dr.funlink.io/api/code/ch',
                    headers: {
                        'accept': '*/*',
                        'accept-language': 'en-US,en;q=0.9',
            ...
            const codeResponse = await new Promise((resolve, reject) => {
                GM_xmlhttpRequest({
                    method: 'POST',
                    url: 'https://public-dr.funlink.io/api/code/code',
                    headers: {
                        'accept': '*/*',
                        'accept-language': 'en-US,en;q=0.9',
                        'cache-control': 'max-age=0',
            ...
            const finalResponse = await new Promise((resolve, reject) => {
                GM_xmlhttpRequest({
                    method: 'POST',
                    url: 'https://public-dr.funlink.io/api/url/tracking-url',
                    headers: {
